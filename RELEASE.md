...
* Fix bug#146 in set_cpd() where only pd.MultiIndex dataframes were considered which is the case when the node has atleast one parent. The fix accounts for parentless nodes as well. 
